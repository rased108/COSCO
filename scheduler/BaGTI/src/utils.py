...
def load_energy_latencyw_data(HOSTS):
	dataset_path = 'datasets/energy_latencyw_'+str(HOSTS)+'_scheduling.csv'
	data = pd.read_csv(dataset_path) if os.path.exists(dataset_path) else pd.read_csv('scheduler/BaGTI/'+dataset_path)
	data = data.values.astype(np.float)
	max_ips_container = max(data.max(0)[HOSTS:2*HOSTS])
	dataset = []
...
def load_energy_latency2w2_data(HOSTS):
	dataset_path = 'datasets/energy_latency2w2_'+str(HOSTS)+'_scheduling.csv'
...
def load_energy_latency1_data(HOSTS):
	dataset_path = 'datasets/energy_latency1_'+str(HOSTS)+'_scheduling.csv'
	data = pd.read_csv(dataset_path) if os.path.exists(dataset_path) else pd.read_csv('scheduler/BaGTI/'+dataset_path)
	data = data.values.astype(np.float)
	max_ips_container = max(data.max(0)[HOSTS:2*HOSTS])
	dataset = []
...
def load_energy_latency2w_data(HOSTS):
	dataset_path = 'datasets/energy_latency2w_'+str(HOSTS)+'_scheduling.csv'
	data = pd.read_csv(dataset_path, header=None) if os.path.exists(dataset_path) else pd.read_csv('scheduler/BaGTI/'+dataset_path, header=None)
	data = data.values.astype(np.float)
	max_ips_container = max(data.max(0)[HOSTS:2*HOSTS])
	max_energy = data.max(0)[3*HOSTS]
...
def load_energy_latency2w1_data(HOSTS):
	dataset_path = 'datasets/energy_latency2w_'+str(HOSTS)+'_scheduling.csv'
	data = pd.read_csv(dataset_path, header=None) if os.path.exists(dataset_path) else pd.read_csv('scheduler/BaGTI/'+dataset_path, header=None)
	data = data.values.astype(np.float)
	max_ips_container = max(data.max(0)[HOSTS:2*HOSTS])
